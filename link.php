<?php
	...
	$p=array(   
		'students' => array(
			'profile_pic' => $Translation['ImageFolder'],
			'overwatch_stats' => '',
			'primary key' => 'id'
		),
		'teams' => array(
			'team_logo' => $Translation['ImageFolder'],
			'primary key' => 'id'
		),
		'schools' => array(
			'school_crest' => $Translation['ImageFolder'],
			'primary key' => 'id'
		),
		'games' => array(
			'game_logo' => $Translation['ImageFolder'],
			'pegi_rating' => $Translation['ImageFolder'],
			'primary key' => 'id'
		)
	);
