<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'test2' table. 
	...
	*/
	...
	function test2_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function test2_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function test2_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function test2_before_insert(&$data, $memberInfo, &$args){
	 ...
	 * For this table, the array items are: 
	 *     $data['field1'], $data['field2'], $data['field3'], $data['created_by']
	...
	*/
	...
	function test2_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['field1'], $data['field2'], $data['field3']
	...
	*/
	...
	function test2_before_update(&$data, $memberInfo, &$args){
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['field1'], $data['field2'], $data['field3'], $data['created_by']
	...
	*/
	...
	function test2_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function test2_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function test2_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function test2_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function test2_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function test2_batch_actions(&$args){
