<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'students' table. 
	...
	*/
	 ...
	 *     $data['profile_pic'], $data['first_name'], $data['last_name'], $data['gamertag'], $data['gender'], $data['school'], $data['year_group'], $data['tutor_group'], $data['role_type'], $data['role'], $data['team'], $data['email'], $data['profile_text'], $data['overwatch_stats']
	...
	*/
	 ...
	 * For this table, the array items are: 
	 *     $data['profile_pic'], $data['first_name'], $data['last_name'], $data['gamertag'], $data['gender'], $data['school'], $data['year_group'], $data['tutor_group'], $data['role_type'], $data['role'], $data['team'], $data['email'], $data['profile_text'], $data['overwatch_stats'], $data['created_by'], $data['edited_by']
	...
	*/
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['profile_pic'], $data['first_name'], $data['last_name'], $data['gamertag'], $data['gender'], $data['school'], $data['year_group'], $data['tutor_group'], $data['role_type'], $data['role'], $data['team'], $data['email'], $data['profile_text'], $data['overwatch_stats']
	...
	*/
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['profile_pic'], $data['first_name'], $data['last_name'], $data['gamertag'], $data['gender'], $data['school'], $data['year_group'], $data['tutor_group'], $data['role_type'], $data['role'], $data['team'], $data['email'], $data['profile_text'], $data['overwatch_stats'], $data['created_by'], $data['edited_by']
