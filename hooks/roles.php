<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'roles' table. 
	...
	*/
	...
	function roles_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function roles_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function roles_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function roles_before_insert(&$data, $memberInfo, &$args){
	 ...
	 * For this table, the array items are: 
	 *     $data['role'], $data['role_type'], $data['created_by'], $data['edited_by']
	...
	*/
	...
	function roles_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['role'], $data['role_type']
	...
	*/
	...
	function roles_before_update(&$data, $memberInfo, &$args){
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['role'], $data['role_type'], $data['created_by'], $data['edited_by']
	...
	*/
	...
	function roles_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function roles_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function roles_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function roles_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function roles_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function roles_batch_actions(&$args){
