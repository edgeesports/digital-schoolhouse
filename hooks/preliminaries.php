<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'preliminaries' table. 
	...
	*/
	...
	function preliminaries_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function preliminaries_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function preliminaries_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function preliminaries_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function preliminaries_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function preliminaries_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function preliminaries_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function preliminaries_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function preliminaries_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function preliminaries_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function preliminaries_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function preliminaries_batch_actions(&$args){
