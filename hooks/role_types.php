<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'role_types' table. 
	...
	*/
	...
	function role_types_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function role_types_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function role_types_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function role_types_before_insert(&$data, $memberInfo, &$args){
	 ...
	 * For this table, the array items are: 
	 *     $data['role_type'], $data['created_by'], $data['edited_by']
	...
	*/
	...
	function role_types_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function role_types_before_update(&$data, $memberInfo, &$args){
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['role_type'], $data['created_by'], $data['edited_by']
	...
	*/
	...
	function role_types_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function role_types_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function role_types_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function role_types_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function role_types_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function role_types_batch_actions(&$args){
