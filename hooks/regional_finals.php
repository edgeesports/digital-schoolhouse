<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'regional_finals' table. 
	...
	*/
	...
	function regional_finals_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function regional_finals_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function regional_finals_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['team'], $data['matches'], $data['wins'], $data['losses'], $data['draws'], $data['points']
	...
	*/
	...
	function regional_finals_before_insert(&$data, $memberInfo, &$args){
	 ...
	 * For this table, the array items are: 
	 *     $data['team'], $data['matches'], $data['wins'], $data['losses'], $data['draws'], $data['points'], $data['created_by'], $data['edited_by']
	...
	*/
	...
	function regional_finals_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['team'], $data['matches'], $data['wins'], $data['losses'], $data['draws'], $data['points']
	...
	*/
	...
	function regional_finals_before_update(&$data, $memberInfo, &$args){
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['team'], $data['matches'], $data['wins'], $data['losses'], $data['draws'], $data['points'], $data['created_by'], $data['edited_by']
	...
	*/
	...
	function regional_finals_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function regional_finals_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function regional_finals_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function regional_finals_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function regional_finals_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function regional_finals_batch_actions(&$args){
