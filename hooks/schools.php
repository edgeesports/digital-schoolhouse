<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'schools' table. 
	...
	*/
	 ...
	 *     $data['school_crest'], $data['school_name'], $data['school_address'], $data['school_postcode'], $data['contact_name'], $data['contact_email'], $data['contact_phone']
	...
	*/
	 ...
	 * For this table, the array items are: 
	 *     $data['school_crest'], $data['school_name'], $data['school_address'], $data['school_postcode'], $data['contact_name'], $data['contact_email'], $data['contact_phone'], $data['created_by'], $data['edited_by']
	...
	*/
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['school_crest'], $data['school_name'], $data['school_address'], $data['school_postcode'], $data['contact_name'], $data['contact_email'], $data['contact_phone']
	...
	*/
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['school_crest'], $data['school_name'], $data['school_address'], $data['school_postcode'], $data['contact_name'], $data['contact_email'], $data['contact_phone'], $data['created_by'], $data['edited_by']
