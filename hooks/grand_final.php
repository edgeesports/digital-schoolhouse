<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'grand_final' table. 
	...
	*/
	...
	function grand_final_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function grand_final_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function grand_final_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function grand_final_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function grand_final_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function grand_final_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function grand_final_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function grand_final_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function grand_final_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function grand_final_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function grand_final_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function grand_final_batch_actions(&$args){
