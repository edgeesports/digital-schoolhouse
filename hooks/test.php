<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'test' table. 
	...
	*/
	...
	function test_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function test_footer($contentType, $memberInfo, &$args){
		$footer='';
	...
	*/
	...
	function test_before_insert(&$data, $memberInfo, &$args){
	...
	*/
	...
	function test_after_insert($data, $memberInfo, &$args){
	...
	*/
	...
	function test_before_update(&$data, $memberInfo, &$args){
	...
	*/
	...
	function test_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function test_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function test_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function test_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function test_batch_actions(&$args){
