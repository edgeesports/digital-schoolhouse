<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'games' table. 
	...
	*/
	...
	function games_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function games_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function games_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['game_logo'], $data['game_title'], $data['pegi_rating']
	...
	*/
	...
	function games_before_insert(&$data, $memberInfo, &$args){
	 ...
	 * For this table, the array items are: 
	 *     $data['game_logo'], $data['game_title'], $data['pegi_rating'], $data['created_by'], $data['edited_by']
	...
	*/
	...
	function games_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['game_logo'], $data['game_title'], $data['pegi_rating']
	...
	*/
	...
	function games_before_update(&$data, $memberInfo, &$args){
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['game_logo'], $data['game_title'], $data['pegi_rating'], $data['created_by'], $data['edited_by']
	...
	*/
	...
	function games_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function games_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function games_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function games_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function games_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function games_batch_actions(&$args){
