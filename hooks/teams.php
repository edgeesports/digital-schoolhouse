<?php
	...
	/**
	 * @file
	 * This file contains hook functions that get called when data operations are performed on 'teams' table. 
	...
	*/
	...
	function teams_init(&$options, $memberInfo, &$args){
	...
	*/
	...
	function teams_header($contentType, $memberInfo, &$args){
		$header='';
	...
	*/
	...
	function teams_footer($contentType, $memberInfo, &$args){
		$footer='';
	 ...
	 *     $data['team_logo'], $data['team_name'], $data['school'], $data['matches'], $data['wins'], $data['losses'], $data['draws'], $data['points']
	...
	*/
	...
	function teams_before_insert(&$data, $memberInfo, &$args){
	 ...
	 * For this table, the array items are: 
	 *     $data['team_logo'], $data['team_name'], $data['school'], $data['matches'], $data['wins'], $data['losses'], $data['draws'], $data['points'], $data['created_by'], $data['edited_by']
	...
	*/
	...
	function teams_after_insert($data, $memberInfo, &$args){
	 ...
	 * Note: if a field is set as read-only or hidden in detail view, it can't be modified through $data. You should use a direct SQL statement instead.
	 * For this table, the array items are: 
	 *     $data['id'], $data['team_logo'], $data['team_name'], $data['school'], $data['matches'], $data['wins'], $data['losses'], $data['draws'], $data['points']
	...
	*/
	...
	function teams_before_update(&$data, $memberInfo, &$args){
	 ...
	 * An associative array where the keys are field names and the values are the field data values.
	 * For this table, the array items are: 
	 *     $data['id'], $data['team_logo'], $data['team_name'], $data['school'], $data['matches'], $data['wins'], $data['losses'], $data['draws'], $data['points'], $data['created_by'], $data['edited_by']
	...
	*/
	...
	function teams_after_update($data, $memberInfo, &$args){
	...
	*/
	...
	function teams_before_delete($selectedID, &$skipChecks, $memberInfo, &$args){
	...
	*/
	...
	function teams_after_delete($selectedID, $memberInfo, &$args){
	...
	*/
	...
	function teams_dv($selectedID, $memberInfo, &$html, &$args){
	...
	*/
	...
	function teams_csv($query, $memberInfo, &$args){
	...
	*/
	...
	function teams_batch_actions(&$args){
