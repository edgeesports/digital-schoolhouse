<?php
	$app_name = 'Digital Schoolhouse powered by PlayStation';
...
<?php if(!$noSignup){ ?>
	<div class="row">
		<div class="hidden-xs col-sm-4 col-md-6 col-lg-8" id="signup_splash">
			...
			<a href="https://www.edgeesports.gg/" target="_blank"><img src="images/dual-logos.png" class="img-responsive" alt="Edge Esports" width="442" height="110"></a>
			<p class="navbar-brand" style="color:#ffffff;text-transform:none">DSH is a Ukie delivered initiative and abides by Ukie's 
			<a href="https://ukie.org.uk/privacy-policy" target="_blank">privacy policy</a>. DSH has partnered with 
			Edge Esports in order to manage the registrations for the Overwatch Digital Schoolhouse Esports Tournament. The platform is GDPR compliant, and Edge Esports' privacy 
			policy can be found <a href="https://www.edgeesports.gg/wp-content/uploads/2018/10/Privacy-Policy.pdf" target="_blank">here</a>. The data gathered will be for the sole 
			purpose of managing and operating the DSH esports tournament and will therefore be shared securely between Ukie's DSH programme and Edge Esports. The data will not be 
			shared with any other third parties. Terms and Conditions for the Overwatch DSH 
			esports tournament can be found <a href="http://digitalschoolhouse.org.uk/terms-and-conditions" target="_blank">here</a>.<br><br>
			Find out more about Digital Schoolhouse <a href="http://www.digitalschoolhouse.org.uk/" target="_blank">here</a>.</p>
			</div>
