...
function students_validateData(){
	...
	if(!$j('[name=gender]:checked').length){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Gender", close: function(){ /* */ $j('[name=gender]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field school can't be empty */
	if($j('#school').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> My School", close: function(){ /* */ $j('[name=school]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field year_group can't be empty */
	if($j('#year_group').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Year Group", close: function(){ /* */ $j('[name=year_group]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field tutor_group can't be empty */
	if($j('#tutor_group').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Tutor Group", close: function(){ /* */ $j('[name=tutor_group]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field role_type can't be empty */
	if($j('#role_type').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Role Type", close: function(){ /* */ $j('[name=role_type]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field role can't be empty */
	if($j('#role').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Role", close: function(){ /* */ $j('[name=role]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field email can't be empty */
	if($j('#email').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Email", close: function(){ /* */ $j('[name=email]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	return true;
}
function teams_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field team_name can't be empty */
	if($j('#team_name').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Team Name", close: function(){ /* */ $j('[name=team_name]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field school can't be empty */
...
function schools_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field school_name can't be empty */
	if($j('#school_name').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> School Name", close: function(){ /* */ $j('[name=school_name]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field school_address can't be empty */
	if($j('#school_address').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Address", close: function(){ /* */ $j('[name=school_address]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	/* Field school_postcode can't be empty */
	if($j('#school_postcode').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Postcode", close: function(){ /* */ $j('[name=school_postcode]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	return true;
}
function help_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Rich HTML area field faq can't be empty */
	var nicfaq = nicEditors.findEditor('faq').getContent();
	if(nicfaq == '' || nicfaq == '<br>' || nicfaq == '<br/>' || nicfaq == '<br>'){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> FAQ", close: function(){ /* */ $j('[name=faq]').parents('.form-group').addClass('has-error'); } }); return false; }
	return true;
}
function role_types_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field role_type can't be empty */
	if($j('#role_type').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Role Type", close: function(){ /* */ $j('[name=role_type]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	return true;
...
function games_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field game_title can't be empty */
	if($j('#game_title').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Game", close: function(){ /* */ $j('[name=game_title]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	return true;
}
function preliminaries_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field team can't be empty */
	if($j('#team').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Team", close: function(){ /* */ $j('[name=team]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	return true;
}
function regional_finals_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field team can't be empty */
	if($j('#team').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Team", close: function(){ /* */ $j('[name=team]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	return true;
}
function grand_final_validateData(){
	$j('.has-error').removeClass('has-error');
	/* Field team can't be empty */
	if($j('#team').val() == ''){ modal_window({ message: '<div class="alert alert-danger"><?php echo addslashes($Translation['field not null']); ?></div>', title: "<?php echo addslashes($Translation['error:']); ?> Team", close: function(){ /* */ $j('[name=team]').eq(0).focus().parents('.form-group').addClass('has-error'); }, footer: [{ label: '<?php echo addslashes($Translation['ok']); ?>' }] }); return false; };
	return true;
...
function persist_expanded_child(id){
	var expand_these = Cookies.getJSON('Digital_Schoolhouse_powered_by_PlayStation.dvp_expand');
	...
	if($j('[id=' + id + ']').hasClass('active')){
		if(expand_these.indexOf(id) < 0){
			...
			Cookies.set('Digital_Schoolhouse_powered_by_PlayStation.dvp_expand', expand_these, { expires: 30 });
		}
	}else{
		if(expand_these.indexOf(id) >= 0){
