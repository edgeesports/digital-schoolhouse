	...
	$lookups = array(   
		'students' => array(   
			'school' => array(
				...
				'parent_pk_field' => 'id',
				'parent_caption' => '`schools`.`school_name`',
				'parent_from' => '`schools` ',
				'filterers' => array(),
				'custom_query' => '',
			...
			'role_type' => array(
				'parent_table' => 'role_types',
				'parent_pk_field' => 'id',
				'parent_caption' => '`role_types`.`role_type`',
				'parent_from' => '`role_types` ',
				'filterers' => array(),
				'custom_query' => '',
				'inherit_permissions' => true,
				'list_type' => 0,
			...
			'role' => array(
				'parent_table' => 'roles',
				'parent_pk_field' => 'id',
				'parent_caption' => '`roles`.`role`',
				'parent_from' => '`roles` LEFT JOIN `role_types` as role_types1 ON `role_types1`.`id`=`roles`.`role_type` ',
				'filterers' => array('role_type' => 'role_type'),
				'custom_query' => '',
				'inherit_permissions' => true,
				'list_type' => 0,
				'not_null' => true
			...
			'team' => array(
				'parent_table' => 'teams',
				'parent_pk_field' => 'id',
				'parent_caption' => '`teams`.`team_name`',
				'parent_from' => '`teams` LEFT JOIN `schools` as schools1 ON `schools1`.`id`=`teams`.`school` ',
