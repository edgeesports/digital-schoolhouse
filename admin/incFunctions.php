<?php
	...
	*/
	...
	function get_tables_info($skip_authentication = false){
		...
		$all_tables = array(
			/* ['table_name' => [table props assoc array] */   
				'students' => array(
					'Caption' => 'Students',
					'Description' => 'This section lists all the students participating in the Digital Schoolhouse esports programme, identified by school and team. Not all roles in the programme are tied to specific teams, so not all students will be members of specific teams.',
				...
				'teams' => array(
					'Caption' => 'Teams',
					'Description' => 'This section lists all the teams participating in the Digital Schoolhouse esports programme, identified by school. Anyone can create or join a team, but typically it would be the Team Manager who creates the team and has managing rights over it.',
				...
				'schools' => array(
					'Caption' => 'Schools',
					'Description' => 'This section lists all the schools participating in the Digital Schoolhouse esports programme.<br> During the initial phases of the programme you may only see your own school here.',
				...
				'help' => array(
					'Caption' => 'FAQ',
					'Description' => 'Help and FAQ for the Digital Schoolhouse esports platform - new users will find here tips and tricks and a guide to getting started.',
				...
				'games' => array(
					'Caption' => 'Games',
					'Description' => 'Games currently supported by the Digital Schoolhouse esports programme with PEGI ratings for school and parental control.',
					'tableIcon' => 'resources/table_icons/controller.png',
					'group' => $tg[0],
					'homepageShowCount' => 1
				),
				'preliminaries' => array(
					'Caption' => 'Preliminaries',
					'Description' => 'This section lists the teams participating in the preliminaries to compete in the regional finals.',
					'tableIcon' => 'resources/table_icons/traffic_lights_green.png',
					'group' => $tg[0],
					'homepageShowCount' => 1
				),
				'regional_finals' => array(
					'Caption' => 'Regional Finals',
					'Description' => 'This section lists the teams qualified from the preliminaries to compete for a place at the grand final.',
					'tableIcon' => 'resources/table_icons/traffic_lights_yellow.png',
					'group' => $tg[0],
					'homepageShowCount' => 1
				),
				'grand_final' => array(
					'Caption' => 'Grand Final',
					'Description' => 'This section lists the teams qualified from the regional finals to compete in the grand final.',
					'tableIcon' => 'resources/table_icons/traffic_lights_red.png',
					'group' => $tg[0],
					'homepageShowCount' => 1
				)
		);
	...
	function getThumbnailSpecs($tableName, $fieldName, $view){
		if($tableName=='students' && $fieldName=='profile_pic' && $view=='tv')
			return array('width'=>50, 'height'=>50, 'identifier'=>'_tv');
		elseif($tableName=='students' && $fieldName=='profile_pic' && $view=='dv')
			return array('width'=>250, 'height'=>250, 'identifier'=>'_dv');
		elseif($tableName=='teams' && $fieldName=='team_logo' && $view=='tv')
			return array('width'=>50, 'height'=>50, 'identifier'=>'_tv');
		elseif($tableName=='teams' && $fieldName=='team_logo' && $view=='dv')
			return array('width'=>250, 'height'=>250, 'identifier'=>'_dv');
		elseif($tableName=='schools' && $fieldName=='school_crest' && $view=='tv')
			return array('width'=>50, 'height'=>50, 'identifier'=>'_tv');
		elseif($tableName=='schools' && $fieldName=='school_crest' && $view=='dv')
			return array('width'=>250, 'height'=>250, 'identifier'=>'_dv');
		elseif($tableName=='games' && $fieldName=='game_logo' && $view=='tv')
			return array('width'=>50, 'height'=>50, 'identifier'=>'_tv');
		elseif($tableName=='games' && $fieldName=='game_logo' && $view=='dv')
			return array('width'=>250, 'height'=>250, 'identifier'=>'_dv');
		elseif($tableName=='games' && $fieldName=='pegi_rating' && $view=='tv')
			return array('width'=>50, 'height'=>50, 'identifier'=>'_tv');
		elseif($tableName=='games' && $fieldName=='pegi_rating' && $view=='dv')
			return array('width'=>250, 'height'=>250, 'identifier'=>'_dv');
		return FALSE;
	}
	########################################################################
