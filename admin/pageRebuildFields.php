	...
	*/
	...
	$schema = array(   
		'students' => array(   
			...
			'profile_pic' => array('appgini' => 'VARCHAR(80) '),
			'first_name' => array('appgini' => 'VARCHAR(80) not null '),
			'last_name' => array('appgini' => 'VARCHAR(80) not null '),
			'gamertag' => array('appgini' => 'VARCHAR(80) '),
			'gender' => array('appgini' => 'VARCHAR(80) not null '),
			'school' => array('appgini' => 'INT unsigned not null '),
			'year_group' => array('appgini' => 'VARCHAR(80) not null '),
			'tutor_group' => array('appgini' => 'VARCHAR(80) not null '),
			'role_type' => array('appgini' => 'INT unsigned not null '),
			'role' => array('appgini' => 'INT unsigned not null '),
			'team' => array('appgini' => 'INT unsigned '),
			'email' => array('appgini' => 'VARCHAR(80) not null unique '),
			'profile_text' => array('appgini' => 'TEXT '),
			'overwatch_stats' => array('appgini' => 'VARCHAR(80) '),
			'created_by' => array('appgini' => 'VARCHAR(80) '),
			'edited_by' => array('appgini' => 'VARCHAR(80) ')
		),
		'teams' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'team_logo' => array('appgini' => 'VARCHAR(80) '),
			'team_name' => array('appgini' => 'VARCHAR(80) not null unique '),
			'school' => array('appgini' => 'INT unsigned not null '),
			'matches' => array('appgini' => 'SMALLINT default \'0\' '),
			'wins' => array('appgini' => 'SMALLINT default \'0\' '),
			'losses' => array('appgini' => 'SMALLINT default \'0\' '),
			'draws' => array('appgini' => 'SMALLINT default \'0\' '),
			'points' => array('appgini' => 'SMALLINT default \'0\' '),
			'created_by' => array('appgini' => 'VARCHAR(80) '),
			'edited_by' => array('appgini' => 'VARCHAR(80) ')
		),
		'schools' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'school_crest' => array('appgini' => 'VARCHAR(80) '),
			'school_name' => array('appgini' => 'VARCHAR(80) not null unique '),
			'school_address' => array('appgini' => 'VARCHAR(80) not null '),
			'school_postcode' => array('appgini' => 'VARCHAR(80) not null '),
			'contact_name' => array('appgini' => 'VARCHAR(80) '),
			'contact_email' => array('appgini' => 'VARCHAR(80) '),
			'contact_phone' => array('appgini' => 'VARCHAR(80) '),
			'esports_coach' => array('appgini' => 'VARCHAR(80) '),
			'created_by' => array('appgini' => 'VARCHAR(80) '),
			'edited_by' => array('appgini' => 'VARCHAR(80) ')
		),
		'help' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'faq' => array('appgini' => 'TEXT not null ')
		),
		'role_types' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'role_type' => array('appgini' => 'VARCHAR(80) not null unique '),
			'created_by' => array('appgini' => 'VARCHAR(80) '),
			'edited_by' => array('appgini' => 'VARCHAR(80) ')
		),
		'roles' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'role' => array('appgini' => 'VARCHAR(40) not null unique '),
			'role_type' => array('appgini' => 'INT unsigned '),
			'created_by' => array('appgini' => 'VARCHAR(80) '),
			'edited_by' => array('appgini' => 'VARCHAR(80) ')
		),
		'games' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'game_logo' => array('appgini' => 'VARCHAR(40) '),
			'game_title' => array('appgini' => 'VARCHAR(40) not null unique '),
			'pegi_rating' => array('appgini' => 'VARCHAR(40) '),
			'created_by' => array('appgini' => 'VARCHAR(80) '),
			'edited_by' => array('appgini' => 'VARCHAR(80) ')
		),
		'preliminaries' => array(   
			'id' => array('appgini' => 'INT unsigned not null primary key auto_increment '),
			'team' => array('appgini' => 'INT unsigned not null '),
			'matches' => array('appgini' => 'SMALLINT default \'0\' '),
			'wins' => array('appgini' => 'SMALLINT default \'0\' '),
			'losses' => array('appgini' => 'SMALLINT default \'0\' '),
			'draws' => array('appgini' => 'SMALLINT default \'0\' '),
